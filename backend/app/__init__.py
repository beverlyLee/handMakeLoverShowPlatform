...
def create_app(config_class=Config):
    ...
    from app.routes import main_bp, auth_bp, product_bp, order_bp, user_bp, message_bp, review_bp, cart_bp, favorite_bp, search_bp, specialty_bp, promotion_bp, upload_bp, activity_bp, admin_bp
